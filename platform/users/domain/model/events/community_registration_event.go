...
// CommunityRegistrationEvent represents the event when a user registers in the community
type CommunityRegistrationEvent struct {
...
func (e CommunityRegistrationEvent) GetOccurredOn() time.Time {
